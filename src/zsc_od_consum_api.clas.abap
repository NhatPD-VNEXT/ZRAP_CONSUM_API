...
CLASS zsc_od_consum_api DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      ...
      BEGIN OF tys_value_controls_12,
        ...
        "! SLS_CONTR_AUTO_ASSGMT_IDFO
        sls_contr_auto_assgmt_idfo TYPE /iwbep/v4_value_control,
        "! YY_1_DELIVERYDATE_PROC_SDI
        yy_1_deliverydate_proc_sdi TYPE /iwbep/v4_value_control,
        "! YY_1_ISSUE_DATE_SDI
        yy_1_issue_date_sdi        TYPE /iwbep/v4_value_control,
        "! ITEM_PARTNER
    ...
    TYPES:
      ...
      BEGIN OF tys_sales_order_item_type,
        ...
        "! YY1_ISSUE_TIME_SDI
        yy_1_issue_time_sdi        TYPE timn,
        "! YY1_MMPURDOC_IM_TXT01_SDI
        yy_1_mmpurdoc_im_txt_01_sd TYPE c LENGTH 30,
        "! YY1_SD_SALESDOCITEM00_SDI
        yy_1_sd_salesdocitem_00_sd TYPE decfloat16,
        "! YY1_SD_SALESDOCITEM00_SDIC
        yy_1_sd_salesdocitem_00__2 TYPE c LENGTH 3,
        "! YY1_Deliverydate_proc_SDI
        yy_1_deliverydate_proc_sdi TYPE datn,
        "! YY1_TEST_QUOTATION_SDI
        yy_1_test_quotation_sdi    TYPE c LENGTH 20,
        "! YY1_ADD_CUSTOM_FIELD_SDI
        yy_1_add_custom_field_sdi  TYPE c LENGTH 20,
        "! YY1_Delivery_Time_SDI
        yy_1_delivery_time_sdi     TYPE timn,
        "! YY1_ISSUE_DATE_SDI
        yy_1_issue_date_sdi        TYPE datn,
        "! SAP__Messages
        sap_messages               TYPE tyt_sap_message,
        "! odata.etag
        etag                       TYPE string,
    ...
    TYPES:
      ...
      BEGIN OF tys_sales_order_type,
        ...
        "! YY1_TEST_QUOTATION_HDR_SDH
        yy_1_test_quotation_hdr_sd TYPE c LENGTH 20,
        "! ZZ_CRE_FURU_FLAG_SDH
        zz_cre_furu_flag_sdh       TYPE abap_bool,
        "! SAP__Messages
        sap_messages               TYPE tyt_sap_message,
        "! odata.etag
        etag                       TYPE string,
...
CLASS ZSC_OD_CONSUM_API IMPLEMENTATION.
  ...
  METHOD def_sales_order_item_type.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'YY_1_ISSUE_TIME_SDI' ).
    lo_primitive_property->set_edm_name( 'YY1_ISSUE_TIME_SDI' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'TimeOfDay' ) ##NO_TEXT.

    lo_primitive_property = lo_entity_type->get_primitive_property( 'YY_1_MMPURDOC_IM_TXT_01_SD' ).
    lo_primitive_property->set_edm_name( 'YY1_MMPURDOC_IM_TXT01_SDI' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 30 ) ##NUMBER_OK.

    lo_primitive_property = lo_entity_type->get_primitive_property( 'YY_1_SD_SALESDOCITEM_00_SD' ).
    lo_primitive_property->set_edm_name( 'YY1_SD_SALESDOCITEM00_SDI' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 15 ) ##NUMBER_OK.
    lo_primitive_property->set_scale_variable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'YY_1_SD_SALESDOCITEM_00__2' ).
    lo_primitive_property->set_edm_name( 'YY1_SD_SALESDOCITEM00_SDIC' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 3 ) ##NUMBER_OK.

    lo_primitive_property = lo_entity_type->get_primitive_property( 'YY_1_DELIVERYDATE_PROC_SDI' ).
    lo_primitive_property->set_edm_name( 'YY1_Deliverydate_proc_SDI' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Date' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    lo_primitive_property->create_vcs_value_control( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'YY_1_TEST_QUOTATION_SDI' ).
    lo_primitive_property->set_edm_name( 'YY1_TEST_QUOTATION_SDI' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 20 ) ##NUMBER_OK.

    lo_primitive_property = lo_entity_type->get_primitive_property( 'YY_1_ADD_CUSTOM_FIELD_SDI' ).
    lo_primitive_property->set_edm_name( 'YY1_ADD_CUSTOM_FIELD_SDI' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 20 ) ##NUMBER_OK.

    lo_primitive_property = lo_entity_type->get_primitive_property( 'YY_1_DELIVERY_TIME_SDI' ).
    lo_primitive_property->set_edm_name( 'YY1_Delivery_Time_SDI' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'TimeOfDay' ) ##NO_TEXT.

    lo_primitive_property = lo_entity_type->get_primitive_property( 'YY_1_ISSUE_DATE_SDI' ).
    lo_primitive_property->set_edm_name( 'YY1_ISSUE_DATE_SDI' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Date' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    lo_primitive_property->create_vcs_value_control( ).
  ...
  METHOD def_sales_order_type.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'YY_1_TEST_QUOTATION_HDR_SD' ).
    lo_primitive_property->set_edm_name( 'YY1_TEST_QUOTATION_HDR_SDH' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 20 ) ##NUMBER_OK.

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZZ_CRE_FURU_FLAG_SDH' ).
    lo_primitive_property->set_edm_name( 'ZZ_CRE_FURU_FLAG_SDH' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
